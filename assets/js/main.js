...
(function () {
  ...
  var SEASONS = [
    ...
    { months: [3, 4, 5],
      title: 'Расконсервация мото',
      text: 'Аккумулятор, цепь, тормоза, масло' + NB + '— готовим мотоцикл к' + NB + 'первому выезду',
      button: 'Записать мотоцикл', lead: 'Расконсервация мото' },
    { months: [6, 7, 8],
      title: 'Проверка перед отпуском',
      text: 'Тормоза, подвеска, жидкости и' + NB + 'свет' + NB + '— чтобы дальняя дорога обошлась без сюрпризов',
      button: 'Записаться на' + NB + 'проверку', lead: 'Проверка перед поездкой' }
  ];
